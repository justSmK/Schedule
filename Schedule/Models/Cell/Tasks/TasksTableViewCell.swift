...
class TasksTableViewCell: UITableViewCell {
    ...
    let taskName = UILabel(text: "Coding", font: .avenirNextDemiBold20(), alignment: .left)
    let taskDescription = UILabel(text: "Learning code extention", font: .avenirNext14(), alignment: .left)
